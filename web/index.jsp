			...
			<div class="side-content fr">
				<div class="content-module">
					...
					<div class="content-module-heading cf">
						...
						<h3 class="fl">Welcome to Engineer Bookstore</h3>

					</div>

					<div class="content-module-main">
						<p>
							You have already accessed to Engineer Bookstore as <strong>${sessionScope.username}</strong>
							account.
						</p>
					</div>
				</div>
			...
			<div class="side-content fr">
				<div class="content-module">
					...
					<div class="content-module-main">
						...
						<p>Please click top left button to login your account.</p>
