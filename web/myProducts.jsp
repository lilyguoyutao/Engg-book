...
<script type="text/javascript">
	function submitDeleteProduct(productId) {
		document.DeleteSellerProductServlet.productId.value = productId;
		document.DeleteSellerProductServlet.submit();
	}
	...
	function submitEditProduct(productId) {
		document.EditProductServlet.productId.value = productId;
		document.EditProductServlet.submit();
	}
			...
			<div class="side-content fr">
				<div class="content-module">
					...
					<div class="content-module-heading cf">
						...
						<h3 class="fl">My Product Search</h3>
								...
								<tbody>
									<c:forEach var="product" items="${productsList}">
										<tr>
											...
											<td><a class="table-actions-button ic-table-edit"
												href="ViewProductServlet?productId=${product.productId}"
												title="Edit Product"></a></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
					...
					<form action="DeleteSellerProductServlet" method="POST" name="DeleteSellerProductServlet">
